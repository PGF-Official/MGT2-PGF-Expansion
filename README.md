Make sure to do a fresh install each update.
Its easier to delete the Mad Games Tycoon 2 folder itself and then click verify files (on steam) and let it re-install.
...
CHANGES:
Dev Legends perk changes
Licenses errors fixed, including suitable genres.
